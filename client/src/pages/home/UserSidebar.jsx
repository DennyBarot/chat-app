    ...
    <div className="w-80 h-full flex flex-col bg-white shadow-lg z-10">
      ...
      <div className="p-4 border-b border-slate-200 flex justify-between items-center">
        ...
        <label className="swap swap-rotate">
          <input type="checkbox" onChange={toggleTheme} checked={theme !== 'Default'} />
          ...
          <svg className="swap-off fill-current w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21.64,13.14a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13.14Zm-5.09-1.54A10.73,10.73,0,0,1,14.08,5.1,8.4,8.4,0,0,1,14.8,2.92,8.07,8.07,0,0,1,18,11.2a8.51,8.51,0,0,1-1.5-1.61Z"/></svg>
        </label>
      </div>
