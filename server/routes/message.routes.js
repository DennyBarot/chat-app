...
import {sendMessage, getMessages, getConversations, markMessagesRead, reactToMessage} from '../controllers/message.controller.js';
...
router.post('/:message_id/react', isAuthenticated, reactToMessage);
